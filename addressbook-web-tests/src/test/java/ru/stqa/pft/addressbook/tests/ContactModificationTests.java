...
public class ContactModificationTests  extends TestBase {
  ...
  public void testContactModification(){
    ...
    app.getContactHelper().fillContactForm(new ContactData(before.get(before.size() - 1).getId(), "OLYA", "N", "Burnayeva", "Kate", "automation developer", "Koolspan",
            "Bethestda", "301-240-234", "301-3234-234", "234-435-342", "32423-2342",
            "yekaterin@gmail.com", 12, 11, "1989", null), false);

...
public class ContactCreation2 {
    ...
    public void ContactCreation2() {
        login("admin", "secret");
        gotoAddNew();
        fillContactForm(new ContactData("Yekaterina", "N", "Teplyakova", "Kate", "automation developer", "Koolspan", "Bethestda", "301-240-234", "301-3234-234", "234-435-342", "32423-2342", "yekaterin@gmail.com", 12, 11, "1989"));
        submitGroupCreation();
        returnToContactPage();
    }
